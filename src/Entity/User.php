...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'users', targetEntity: ComputerListByUser::class)]
    ...
    public function addComputerFav(ComputerListByUser $computerFav): self
    {
    ...
    public function removeComputerFav(ComputerListByUser $computerFav): self
    {
        if ($this->computerFav->removeElement($computerFav)) {
            // set the owning side to null (unless already changed)
            if ($computerFav->getComputers() === $this) {
                $computerFav->setComputers(null);
            }
        }
